// Rosetta Code task: Cycles of a permutation
// Source: https://rosettacode.org/wiki/Cycles_of_a_permutation#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// On Thursdays Alf and Betty should rearrange their letters using these cycles:
// (4 2 8 7 3 11 10 15 5 14) (13 9 12) 
...
// (4 14 5 15 10 11 3 7 8 2) (13 12 9) 
//
