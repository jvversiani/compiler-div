// Rosetta Code task: Conditional structures
// Source: https://rosettacode.org/wiki/Conditional_structures#Rust
...
fn main() {
    // Calls whichever running_linux() was compiled in for this target OS.
    running_linux();
}