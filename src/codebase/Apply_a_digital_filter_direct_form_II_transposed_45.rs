// Rosetta Code task: Apply a digital filter (direct form II transposed)
// Source: https://rosettacode.org/wiki/Apply_a_digital_filter_(direct_form_II_transposed)#Rust
