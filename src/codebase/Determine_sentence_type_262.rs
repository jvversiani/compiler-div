// Rosetta Code task: Determine sentence type
// Source: https://rosettacode.org/wiki/Determine_sentence_type#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// "hi there, how are you today?" → Question
// "I'd like to present to you the washing machine 9001." → Serious
// "You have been nominated to win one of these!" → Exclamation
// "Just make sure you don't break it" → Neutral
// =======================
