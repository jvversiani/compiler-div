// Rosetta Code task: Stable marriage problem
// Source: https://rosettacode.org/wiki/Stable_marriage_problem#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Engagements:
//   {"abi": "jon", "bea": "fred", "cath": "bob", "dee": "col", "eve": "hal", "fay": "dan", "gay": "gav", "hope": "ian", "ivy": "abe", "jan": "ed"}
//
// Couples:
...
fn matchmaker(
    ...
    let mut engaged: BTreeMap<String, String> = BTreeMap::new();
...
fn check_engagement(
    engaged: &BTreeMap<String, String>,
    men_preferences: &BTreeMap<String, Vec<String>>,
    women_preferences: &BTreeMap<String, Vec<String>>,
) -> bool {
    let inverse_engaged: BTreeMap<String, String> = engaged.iter().map(|(k, v)| (v.clone(), k.clone())).collect();
...
fn main() {
    let men_preferences: BTreeMap<String, Vec<String>> = [
    ...
    let women_preferences: BTreeMap<String, Vec<String>> = [
