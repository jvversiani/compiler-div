// Rosetta Code task: Multidimensional Newton-Raphson method
// Source: https://rosettacode.org/wiki/Multidimensional_Newton-Raphson_method#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// x = 1.2333177930042694, y = 0.212245014464034
// x = 0.8936282344764825, y = 0.8945270103905782, z = -0.040089286159152804
// =======================
