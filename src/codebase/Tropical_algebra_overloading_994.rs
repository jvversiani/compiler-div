// Rosetta Code task: Tropical algebra overloading
// Source: https://rosettacode.org/wiki/Tropical_algebra_overloading#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// 2 * -2 == MaxTropical { x: 0.0 }
// -0.001 + -Inf == MaxTropical { x: -0.001 }
// 0 * -Inf == MaxTropical { x: -inf }
// 1.5 + -1 == MaxTropical { x: 1.5 }
// -0.5 * 0 == MaxTropical { x: -0.5 }
// 5.pow(7) == MaxTropical { x: 35.0 }
// 5 * (8 + 7)) == MaxTropical { x: 13.0 }
// 5 * 8 + 5 * 7 == MaxTropical { x: 13.0 }
