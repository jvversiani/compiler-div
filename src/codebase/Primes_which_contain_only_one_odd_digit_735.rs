// Rosetta Code task: Primes which contain only one odd digit
// Source: https://rosettacode.org/wiki/Primes_which_contain_only_one_odd_digit#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Prime numbers under 1000 with only one odd digit:
