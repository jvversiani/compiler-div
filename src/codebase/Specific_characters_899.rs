// Rosetta Code task: Specific characters
// Source: https://rosettacode.org/wiki/Specific_characters#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Specific char counts in the 3 words: [2, 1, 0]
// Nonspecific char counts in the 3 words: [5, 5, 9]
// =======================
