// Rosetta Code task: Convert seconds to compound duration
// Source: https://rosettacode.org/wiki/Convert_seconds_to_compound_duration#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Before: 0w 3d 182h 345m 2412s
// After: 1w 3d 20h 25m 12s
// =======================
