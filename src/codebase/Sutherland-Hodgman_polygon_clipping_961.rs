// Rosetta Code task: Sutherland-Hodgman polygon clipping
// Source: https://rosettacode.org/wiki/Sutherland-Hodgman_polygon_clipping#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Polygon([Point { x: 100.0, y: 116.66666666666667 }, Point { x: 125.00000000000001, y: 100.0 }, Point { x: 275.0, y: 100.0 }, Point { x: 300.0, y: 116.66666666666667 }, Point { x: 300.0, y: 299.99999999999994 }, Point { x: 250.0, y: 300.0 }, Point { x: 200.0, y: 250.0 }, Point { x: 175.0, y: 300.0 }, Point { x: 125.0, y: 300.0 }, Point { x: 100.0, y: 250.0 }])
// =======================
