// Rosetta Code task: Weiler-Atherton polygon clipping
// Source: https://rosettacode.org/wiki/Weiler-Atherton_polygon_clipping#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// is_in_line test 1: PASS
// is_in_line test 2: PASS
// clip test: PASS - Found 2 polygons
