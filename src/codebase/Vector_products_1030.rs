// Rosetta Code task: Vector products
// Source: https://rosettacode.org/wiki/Vector_products#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// a . b = 49
// a x b = Vector { x: 5.0, y: 5.0, z: -7.0 }
// a . (b x c) = 6
// a x (b x c) = Vector { x: -267.0, y: 204.0, z: -3.0 }
// =======================
