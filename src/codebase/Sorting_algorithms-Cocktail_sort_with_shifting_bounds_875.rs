// Rosetta Code task: Sorting algorithms/Cocktail sort with shifting bounds
// Source: https://rosettacode.org/wiki/Sorting_algorithms/Cocktail_sort_with_shifting_bounds#Rust
