// Rosetta Code task: Egyptian division
// Source: https://rosettacode.org/wiki/Egyptian_division#Rust
...
fn egyptian_divide(dividend: u32, divisor: u32) -> (u32, u32) {
    ...
    let (answer, sum) = doublings
        ...
        .fold((0u64, 0u64), |(answer, sum), (double, power)| {
