// Rosetta Code task: Split a character string based on change of character
// Source: https://rosettacode.org/wiki/Split_a_character_string_based_on_change_of_character#Rust
