// Rosetta Code task: Binary strings
// Source: https://rosettacode.org/wiki/Binary_strings#Rust
...
// Strings are equal
// String is:Hello world!  and  Clone string is: Hello world!
// String copied now: Hello world!
// =======================
