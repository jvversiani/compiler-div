// Rosetta Code task: Pseudo-random numbers/Combined recursive generator MRG32k3a
// Source: https://rosettacode.org/wiki/Pseudo-random_numbers/Combined_recursive_generator_MRG32k3a#Rust
