// Rosetta Code task: Find the intersection of a line with a plane
// Source: https://rosettacode.org/wiki/Find_the_intersection_of_a_line_with_a_plane#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// V3 { x: 0.0, y: -5.0, z: 5.0 }
// =======================
