// Rosetta Code task: Hamiltonian Cycle via Chvátal Closure
// Source: https://rosettacode.org/wiki/Hamiltonian_Cycle_via_Chvátal_Closure#Rust
...
// Found Hamiltonian cycle in original graph:
// 0 → 2 → 1 → 3 → 4 → 0
// =======================
