// Rosetta Code task: Gradient descent
// Source: https://rosettacode.org/wiki/Gradient_descent#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// Using the gradient descent method the minimum point occurs at:
// x = 0.107627, y = -1.223260 for which f(x, y) = -0.750063
// =======================
