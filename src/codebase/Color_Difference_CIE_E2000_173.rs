// Rosetta Code task: Color Difference CIE ΔE2000
// Source: https://rosettacode.org/wiki/Color_Difference_CIE_ΔE2000#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// The color difference is: 55.08046654850587
// =======================
...
fn main(){
	println!("The color difference is: {}", ciede_2000(100.0, 100.0, 100.0, 50.0, 50.0, 255.0));
}