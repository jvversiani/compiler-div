// Rosetta Code task: Rendezvous
// Source: https://rosettacode.org/wiki/Rendezvous#Rust
// Content licensed under GFDL 1.2 (Rosetta Code).
// =======================
// Expected output:
// (Primary) Old Mother Goose,
// (Primary) Humpty Dumpty sat on a wall.
// (Primary) When she wanted to wander,
// (Primary) Humpty Dumpty had a great fall.
// (Primary) Would ride through the air,
//       Printer out of ink
//       Error detected by Humpty, stopping all work.
