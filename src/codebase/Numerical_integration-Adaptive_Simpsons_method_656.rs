// Rosetta Code task: Numerical integration/Adaptive Simpson's method
// Source: https://rosettacode.org/wiki/Numerical_integration/Adaptive_Simpson's_method#Rust
